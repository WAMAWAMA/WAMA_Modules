...
class WideResNet(nn.Module):
    ...
    def __init__(self, block, layers, sample_size = None, sample_duration = None, k=2, shortcut_type='B', num_classes=400, last_fc=True):
...
def generate_model():
    ...
    """
    model = WideResNet(WideBottleneck, [3, 4, 6, 3])
    return model
